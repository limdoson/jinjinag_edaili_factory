<template>
	<div class="">
		...
		<el-table :data='list' 
			...
			<el-table-column prop='order_ind' label='订单编号'></el-table-column>
			<el-table-column prop='product_id' label='商品ID'></el-table-column>
			<el-table-column prop='pay_ind' label='支付单号'></el-table-column>
			<el-table-column prop='money' label='货款'></el-table-column>
